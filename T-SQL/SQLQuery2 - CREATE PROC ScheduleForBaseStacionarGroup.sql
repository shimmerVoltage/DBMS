...
BEGIN
	...
	BEGIN
		--PRINT(@date + DATENAME(WEEKDAY, @date) + ' ' + DATENAME(WEEKDAY, @date));
		--PRINT(FORMATEMESSAGE(N'%d, %s, %i', @date, DATENAME(WEEKDAY, @date), DATEPART(WEEKDAY, @date)))
		--PRINT(@date);
